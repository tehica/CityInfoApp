...
namespace CityInfo.API.Controllers
{
    ...
    public class PointsOfInterestController : Controller
    {
        ...
        private IMailService _mailService;  // private IMailService _mailService;
            ...
            [FromBody] PointOfInterestForCreationDto pointOfInterest)
        {
            ...
            _cityInfoRepository.AddPointsOfInterestForCity(cityId, finalPointOfInterest);
        ...
        [HttpPut("{ciytId}/pointofinterest/{id}")]
        ...
        [HttpPatch("{ciytId}/pointofinterest/{id}")]
        ...
        [HttpDelete("{ciytId}/pointofinterest/{id}")]
        public IActionResult DeletePointOfnterest(int cityId, int id)
        {
            if (!_cityInfoRepository.CityExists(cityId))
            {
                return NotFound();
            ...
            _mailService.Send("Point ofinterest deleted.",
